...
<section class="shell">
  <header class="header">
    <div>
      <h1>Captures</h1>
      <p class="lead">
        All structured Manna captures that are currently surfaced to the app.
      </p>
    </div>
    {#if summary}
  ...
  {#if captures.length === 0}
    <p class="hint">
      No captures available yet. Once transcripts are structured into BE / KNOW / DO / FEEL, they&apos;ll show here.
    </p>
  {:else}

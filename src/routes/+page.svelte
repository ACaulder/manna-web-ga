...
<section class="shell">
  <h1>Manna</h1>
  <p class="lead">
    A private space to prototype your Digital Brain.
  </p>
  <p class="lead">
  ...
  <div class="section">
    ...
    {:else}
      <p class="hint">
        No captures found yet. Once you start processing voice notes into captures, today&apos;s BE / KNOW /
        DO / FEEL will show up here.
      </p>
    {/if}
  </div>
  ...
  <div class="section">
    ...
    <ul>
      ...
      <li>
        ...
        <p class="hint">
          Weekly relational prompts on Monday, Wednesday, and Friday.
        </p>
      </li>
    </ul>
  </div>
  ...
  <div class="section">
    ...
    {:else}
      <p class="hint">
        Status check unavailable. If this persists, verify that <code>/api/ping</code> is
          reachable.
      </p>
    {/if}
  </div>

...
<section class="shell">
  <header class="header">
    <div>
      <h1>People</h1>
      <p class="lead">
        Key people in your world as surfaced by Manna. Each one is a stewarded relationship, not a contact.
      </p>
    </div>
  ...
  {#if people.length === 0}
    <p class="hint">
      No people have been surfaced yet. Once captures are structured and linked, relationships will show here.
    </p>
  {:else}
    <ul class="grid">

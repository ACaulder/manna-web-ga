	...
	<section class="shell">
		...
		<div class="grid">
			<section class="block">
				...
				{:else}
					<p class="hint">
						No snapshot yet. Future structuring will summarize their current season.
					</p>
				{/if}
			...
			<section class="block">
				...
				{:else}
					<p class="hint">
						No story written yet. As captures accumulate, this section can hold a narrative summary
			...
			<section class="block">
				...
				{:else if !person.prayer_focus}
					<p class="hint">
						No current needs recorded. Future structuring can pull these from captures where you
						talk about them.
					</p>
				{/if}
			</section>
		...
		<footer class="footer">
			<p class="hint">
				This dossier is a living summary. It will deepen as Manna links more captures, prayers, and
				decisions to
